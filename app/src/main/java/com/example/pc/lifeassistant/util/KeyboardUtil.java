...
public class KeyboardUtil {
    ...
    private MoneyKeyBoard mKeyboardView;
    ...
    public KeyboardUtil(Activity activity, boolean ifRandom) {
        ...
        mKeyboardNumber = new Keyboard(mActivity, R.xml.symbols);
        mKeyboardView = (MoneyKeyBoard) mActivity.findViewById(R.id.keyboard_view);
    }
    ...
    private KeyboardView.OnKeyboardActionListener mOnKeyboardActionListener = new KeyboardView.OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            } else if (primaryCode == Keyboard.KEYCODE_DONE) {// 确定按钮
                //   hideKeyboard();
                if (mOnOkClick != null) {
    ...
    public void hideKeyboard() {
        // editable.insert(count, Character.toString((char) primaryCode));
//        int visibility = mKeyboardView.getVisibility();
