...
/**
 * Created by pc on 2018/12/9.
 */

public class MoneyKeyBoard extends KeyboardView {
    ...
    public MoneyKeyBoard(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (keys != null) {
            for (Key key : keys) {
                ...
                if (key.codes[0] == -4) {
                    //重画确定键
//                    drawKeyBackground(R.drawable.edit_bg, canvas, key);
//                    drawText(canvas, key);
                }
            }
        }
